...
public class NewWebsiteOrderRouteTest {
	...
	public void setUp() {
		jdbcTemplate.execute(
				"insert into orders.catalogitem (id,itemnumber,itemname,itemtype) values (1,'078-1344200444','Build Your Own JavaScript Framework in Just 24 Hours','Book')");
	...
	public void testNewWebsiteOrderRouteSuccess() throws Exception {
		jdbcTemplate.execute(
				"insert into orders.\"order\" (id,customer_id,orderNumber,timeorderplaced,lastupdate,status) values (1,1,'1001',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'N')");
		jdbcTemplate.execute(
				"insert into orders.orderitem (id,order_id,catalogitem_id,status,price,quantity,lastupdate) values (1,1,1,'N',20.00,1,CURRENT_TIMESTAMP)");
